...
function renderAnx6() {
  if (S.activeProject && S.activeProject.anx6Data) {
    anx6ClusterData = S.activeProject.anx6Data.cluster || [];
    anx6ContiguousData = S.activeProject.anx6Data.contiguous || [];
  }
  renderAnx6Clusters();
...
function saveAnx6StateToProject() {
  if (S.activeProject) {
    S.activeProject.anx6Data = {
      cluster: anx6ClusterData,
      contiguous: anx6ContiguousData
    };
    if (window.debouncedSaveState) window.debouncedSaveState();
  }
}
window.saveAnx6StateToProject = saveAnx6StateToProject;
