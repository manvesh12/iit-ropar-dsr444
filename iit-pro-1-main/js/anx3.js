...
function renderCont() {
  ...
  contData.forEach((row, i) => {
    ...
    tr.innerHTML = `
      ...
      <td ${cEd} onblur="contData[${i}].area=parseFloat(this.innerText.replace(/,/g,''))||0;renderCont()">${(+row.area).toFixed(2)}</td>
      <td ${cEd} onblur="contData[${i}].mineral=parseFloat(this.innerText.replace(/,/g,''))||0;renderCont()">${(+row.mineral).toFixed(2)}</td>
